...
//       <p className="text-xl justify-normal m-7 mt-12 font-semibold">I provide a range of digital services to help you stand out online.<mark className="bg-green-400"> From" logo design ,Graphic design, Video editing & website development
//          to personalized portfolios and custom web projects" </mark>. my goal is to bring your ideas to life. I work closely with 
//          each client to understand exactly what they need, focusing on both style and ease of use. With every project, I make sure the process is clear and smooth from start to finish. Whether you need a unique logo, a personal website, or a custom project,
//          I’m here to create something special that fits your vision.
//          </p>

//          <a href='projects' className='hover:text-green-500 font-black text-4xl text-center hover:underline text-emerald-900'><Link id="projects" href="/project">PROJECTS</Link></a>

//          <p className="text-xl text-center fles justify-center m-7  font-semibold mt-20" >Here are some of my recent projects that showcase my skills and creativity. Each project is designed with care, attention to detail, and a commitment to quality</p>
//     </div>
//   )
// }
